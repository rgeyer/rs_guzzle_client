...
class ServerCommandsTest extends ClientCommandsBase {
	...
	public static function setUpBeforeClass() {
		...
		// TODO: It's a temporary hack to use the second index of the cloud list since my test account
		// has a cloud that is unsupported by the base server templates as the first record.
		self::$_cloud_href = $json_obj[2]->links[0]->href;
		self::$_cloud_name = $json_obj[2]->name;
		...
		self::$_server_href = $command->getResponse()->getHeader('Location');
	}
